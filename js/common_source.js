...
//	};
	...
	$('.cnl-tab').on('click', function () {
		let containerId = this.getAttribute('data-cnl-cont'),
...
window.onload = window.onresize = function () {
	...
	{
		let h = document.querySelector(".page-fixed_header header"),
		...
		if(f) {
			let fh = (document.querySelector('.page-fixed_footer').getBoundingClientRect().height - document.documentElement.clientHeight - 217);
